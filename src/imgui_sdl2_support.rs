...
fn get_mouse_cursor() -> Option<MouseCursor> {
    match unsafe { imgui::sys::igGetMouseCursor() } {
        imgui::sys::ImGuiMouseCursor_Arrow => Some(MouseCursor::Arrow),
        imgui::sys::ImGuiMouseCursor_TextInput => Some(MouseCursor::TextInput),
        imgui::sys::ImGuiMouseCursor_ResizeAll => Some(MouseCursor::ResizeAll),
        imgui::sys::ImGuiMouseCursor_ResizeNS => Some(MouseCursor::ResizeNS),
        imgui::sys::ImGuiMouseCursor_ResizeEW => Some(MouseCursor::ResizeEW),
        imgui::sys::ImGuiMouseCursor_ResizeNESW => Some(MouseCursor::ResizeNESW),
        imgui::sys::ImGuiMouseCursor_ResizeNWSE => Some(MouseCursor::ResizeNWSE),
        imgui::sys::ImGuiMouseCursor_Hand => Some(MouseCursor::Hand),
        imgui::sys::ImGuiMouseCursor_NotAllowed => Some(MouseCursor::NotAllowed),
        _ => None,
    }
}
...
impl SdlPlatform {
    ...
    pub fn prepare_frame(
        ...
        let mouse_cursor = get_mouse_cursor();
        let io = context.io_mut();
