...
impl TilemapRenderer {
    ...
    fn append_spike(
        ...
        if left && !up {
            ...
            rectangle!(0.5 - S, 0.0, S, 0.5);
        } else if !left && up {
            triangle!(0.0, 0.5 - S, 0.25, 0.0, 0.5, 0.5 - S);
            rectangle!(0.0, 0.5 - S, 0.5, S);
        } else if left && up {
        ...
        if right && !up {
            ...
            rectangle!(0.5, 0.0, S, 0.5);
        } else if !right && up {
            triangle!(0.5, 0.5 - S, 0.75, 0.0, 1.0, 0.5 - S);
            rectangle!(0.5, 0.5 - S, 0.5, S);
        } else if right && up {
        ...
        if left && !down {
            ...
            rectangle!(0.5 - S, 0.5, S, 0.5);
        } else if !left && down {
            triangle!(0.0, 0.5 + S, 0.25, 1.0, 0.5, 0.5 + S);
            rectangle!(0.0, 0.5, 0.5, S);
        } else if left && down {
        ...
        if right && !down {
            ...
            rectangle!(0.5, 0.5, S, 0.5);
        } else if !right && down {
            triangle!(0.5, 0.5 + S, 0.75, 1.0, 1.0, 0.5 + S);
            rectangle!(0.5, 0.5, 0.5, S);
        } else if right && down {
