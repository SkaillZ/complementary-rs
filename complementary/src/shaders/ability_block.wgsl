struct AbilityBlockUniforms {
    view_matrix: mat4x4<f32>;
};
[[group(0), binding(0)]] var<uniform> uniforms: AbilityBlockUniforms;
...
[[stage(vertex)]]
fn vs_main(input: VertexInput, instance: AbilityBlockInstance) -> VertexOutput {
